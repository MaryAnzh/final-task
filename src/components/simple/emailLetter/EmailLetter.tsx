export const EmailLetter = (): JSX.Element => (
    <article style={{ borderRadius: 4, overflow: 'hidden', display: 'flex', flexDirection: 'column', width: '100%', boxShadow: '0 0 10px rgba(0, 0, 0, .2)', maxWidth: '400px' }}>
        ...
        <main style={{ width: '100%', background: 'white', padding: '30px' }}>
            ...
            <a href="https://github.com/MaryAnzh" target="_blank" rel="noreferrer" style={{ borderRadius: 3, background: '#314AD7', display: 'flex', marginTop: 10, padding: 10, color: 'white', width: '100%' }}>Mary&apos;s GitHub repository</a>
            <a href="https://github.com/DmitryBaranovAndreevich" rel="noreferrer" target="_blank" style={{ borderRadius: 3, background: '#314AD7', display: 'flex', marginTop: 10, padding: 10, color: 'white', width: '100%' }}>Dmitry&apos;s GitHub repository</a>
            <a href="https://github.com/user-of-github" target="_blank" rel="noreferrer" style={{ borderRadius: 3, background: '#314AD7', display: 'flex', marginTop: 10, padding: 10, color: 'white', width: '100%' }}>Nikita&apos;s GitHub repository</a>
        </main>
    </article>
)
